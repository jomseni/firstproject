INSERT INTO article(id, title, content) VALUES(1,'가가가가','1111'); --article이라는 테이블에 INSERT INTO 할거야~
...
INSERT INTO comment(id, article_id, nickname, body) VALUES (3,4,'Choi','쇼생크의 탈출');  --4번 게시글에 달린 댓글 세개!
